---
name: Config Over Constants
description: Route values through variables, config or environment rather than repeating literals
category: general
tags: [general, maintainability, dry]
---
