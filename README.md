...
| `task docs:prep` | Copy rule sources into the Starlight tree |
...
Handwritten pages live under `docs/src/content/docs/`. Rule pages are generated by `task docs:prep`
and are not committed. Scratch notes stay in `docs/TMP/` and are not published.
